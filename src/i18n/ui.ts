...
export const ui = {
  en: {
    ...
    'pi.title': 'PI',
    'pi.interests': 'Research Interest',
    'pi.education': 'Education',
    'pi.experience': 'Professional Experience',
    'team.title': 'People',
    ...
    'pubs.corresponding': 'Corresponding author',
    'news.title': 'News',
    'news.empty': 'No past news yet. This year\'s news is on the home page.',
  ...
  ko: {
    ...
    'pubs.firstAuthor': '1저자',
    'pubs.corresponding': '교신저자',
    'news.title': '지난 소식',
    'news.empty': '아직 지난 소식이 없습니다. 올해 소식은 홈 화면에서 확인하실 수 있습니다.',
    'news.type.grant': '과제',
    'news.type.honor': '수상',
    'news.type.talk': '발표',
    'news.type.paper': '논문',
